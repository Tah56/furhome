...
import { Button, Input, Label, Select, TextArea, TextField, ListBox } from '@heroui/react';
    ...
    <div className="max-w-4xl mx-auto p-6 md:p-10">
      ...
      <form onSubmit={handleSubmit} className="space-y-8">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <Select name="Species" isRequired>
              ...
              <Select.Popover>
                <ListBox>
                  ...
                  <ListBox.Item id="turtle" textValue="turtle">Turtle</ListBox.Item>
          ...
          <div>
            <Select name="vaccine" isRequired>
              ...
              <Select.Popover>
                <ListBox>
                  <ListBox.Item id="yes" textValue="yes">Vaccinated</ListBox.Item>
                  <ListBox.Item id="no" textValue="no">Not Vaccinated</ListBox.Item>
                </ListBox>
              </Select.Popover>
            </Select>
          </div>
        ...
        <TextField name="email">
          ...
          <Input type="email" readOnly value={user?.email || ''} className="rounded-2xl bg-gray-50" />
        </TextField>
